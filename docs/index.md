...
This file should be placed in your `jarvis` folder, alongside the `__main__.py` file . 
...
```
from jarvis.sample_config import Config
...
For queries or any issues regarding the bot please open an issue ticket or visit us at [Jarvis Support](https://t.me/JarvisSupportOT)
...
Special Thanks To [Kigyo Bot](https://github.com/Dank-del/EnterpriseALRobot) For Their SpamProtection Module and ReadMe
